    ...
    <div className="mx-auto w-full max-w-md">
      ...
      {error && (
        <p className="mb-4 rounded-lg bg-red-100 px-3 py-2 text-sm text-red-700">
          Не удалось сохранить изменения. Проверьте поля формы.
        </p>
      )}
      <form action={updateProductAction} className="flex flex-col gap-4">
        ...
        <div className="flex gap-3.5">
          ...
          <label className="flex flex-1 flex-col gap-1.5 text-sm">
            <span className="font-semibold text-[#5A5245]">Старая цена</span>
            <input
              name="old_price"
              type="number"
              step="0.01"
        ...
        <p className="text-xs text-[#8A6A4A]">Артикул: {product.sku}</p>
